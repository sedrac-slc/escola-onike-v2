...
@section('content')
    <div class="card">
        ...
        <span id="formadd" class="d-none fr" data-url="{{ route('funcionarios.store') }}">
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                        ...
                        <form action="{{ route('funcionarios.store') }}" method="POST" id="form">
                            @csrf
                            @method('POST')
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="flush-headingTwo"
                        data-bs-parent="#accordionFlushExample" style="">
                        @include('components.table.funcionario')
                    </div>
                </div>
            </div>
...
@section('script')
    ...
    <script>
        ...
        function text(...arg) {
            ...
            selectDefault(arg[5], 'funcao');
            document.querySelector('#span-funcionario').innerHTML = arg[6];
        }
