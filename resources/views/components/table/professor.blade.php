        ...
        <tbody>
            @foreach ($professores as $professor)
                <tr>
                    ...
                    <td>
                        <span class="text-primary">listar ({{ sizeof($professor->disciplinas) }})</span>
                    </td>
                    <td>
                        <button class="btn btn-outline-danger btn-sm rounded-pill btn-del" data-bs-toggle="modal"
                            data-bs-target="#modalDelete" data-del="{{ route('professores.destroy', $professor->user->id) }}">
                            <div class="th-icone">
                    ...
                    <td>
                        <button class="btn btn-outline-warning btn-sm rounded-pill btn-up" type="button"
                            ...
                            aria-controls="flush-collapseOne" data-up="{{ route('professores.update', $professor->user->id) }}">
                            <div class="th-icone">
