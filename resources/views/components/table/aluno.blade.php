        ...
        <tbody>
            @foreach ($alunos as $aluno)
                <tr>
                    ...
                    <td>
                        @php $count =  0; @endphp
                        <button class="btn btn-outline-info btn-sm rounded-pill @if($count > 0)  @endif" type="button"
                            @if($count > 0)  data-bs-toggle="modal" data-bs-target="#modalCursoDisciplinaHorarioList" data-url="" @endif
                        >
                            <div class="th-icone">
