const btnAlunoMatricula = document.querySelectorAll('.btn-aluno-matricula');
...
btnAlunoMatricula.forEach( item =>{
    item.addEventListener("click",(e)=>{
        document.querySelector('#aluno-matricula').value = item.dataset.aluno
    });
});
